...
const About = () => {
    return (
        <div className="about-section">
            ...
            <p>The Current Critters section - See which critters are available right now according to your local time zone and hemisphere!</p>
            <p>The All Critters section - See a list of all critters available in the game, regardless of time or hemisphere.</p>
